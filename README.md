...
#### Description
This endpoint allows captains to log in to their account.
...
#### Request Headers
- `Authorization` (string, required): The JWT token of the authenticated captain. Must be in the format `Bearer <token>`.
